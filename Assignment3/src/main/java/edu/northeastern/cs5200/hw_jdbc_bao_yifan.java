...
import edu.northeastern.cs5200.storedProcedure.StoredProcedure;
...
public class hw_jdbc_bao_yifan {
    ...
    public static void main(String[] args) {
        ...
        //7.1 GetUnansweredQuestions
        storedProcedure.getUnansweredQuestions();

        //7.2 EndorsedUsersForWeek
        Date week_begin = Date.valueOf("2020-02-20");
        Date week_end = Date.valueOf("2020-02-27");
        storedProcedure.endorsedUsersForWeek(week_begin,week_end);

        System.out.println("Stored Procedure finish!");
    }
}
